...
import com.akinms.apirestful.entity.BodegueroModelAssembler;
...
public class BodegueroRestController {
    ...
    private BodegueroModelAssembler assemblerBodeguero;

    BodegueroRestController(IBodegueroBusiness bodegueroBusiness, BodegueroModelAssembler assemblerBodeguero){
        this.bodegueroBusiness = bodegueroBusiness;
        this.assemblerBodeguero = assemblerBodeguero;
    }

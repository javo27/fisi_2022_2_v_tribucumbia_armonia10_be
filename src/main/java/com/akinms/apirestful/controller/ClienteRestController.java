...
public class ClienteRestController {
    ...
    private ClienteModelAssembler assemblerCliente;

    ClienteRestController(IClienteBusiness clienteBusiness, ClienteModelAssembler assemblerCliente){
        this.clienteBusiness = clienteBusiness;
        this.assemblerCliente = assemblerCliente;
    }
